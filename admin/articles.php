        ...
        <main class="admin-main">
            ...
            <div class="admin-content">
                ...
                <div class="admin-actions">
                    <a href="article_add.php" class="primary-btn">Ajouter un article</a>
                            ...
                            <tbody>
                                <?php while ($article = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <a href="../pages/article.php?id=<?php echo $article['id']; ?>" class="view-btn" title="Voir l'article" target="_blank">Voir</a>
                                            <a href="article_edit.php?id=<?php echo $article['id']; ?>" class="edit-btn" title="Modifier l'article">Modifier</a>
                                            <a href="articles.php?action=delete&id=<?php echo $article['id']; ?>" class="delete-btn" title="Supprimer l'article" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet article ?')">Supprimer</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
